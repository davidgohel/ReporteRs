...
```{r echo=FALSE}
office_web_viewer( url = paste0( "http://davidgohel.github.io/ReporteRs/articles/", basename(template) ) )
```
...
```{r echo=FALSE}
office_web_viewer( url = paste0( "http://davidgohel.github.io/ReporteRs/articles/", basename(target_file) ) )
```
