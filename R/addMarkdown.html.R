#' @title Add a markdown text or file into an html object
#'
#' @description Add markdown into a \code{\link{html}} object.
#' 
#' @param doc Object of class \code{\link{html}} where markdown has to be added
