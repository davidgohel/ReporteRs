#' @title Insert a table into an reveal object
#'
#' @description
#' Insert a table into the \code{reveal} object.
#' 
#' @param doc the \code{reveal} to use
...
#' @seealso \code{\link{reveal}}
#' @method addTable reveal
#' @S3method addTable reveal
addTable.reveal = function(doc, data, layout.properties
