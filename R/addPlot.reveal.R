#' @title Add a plot into an reveal object
#'
#' @description
#' Add a plot into the \code{reveal} object.
#' 
...
#' @seealso \code{\link{reveal}}, \code{\link{addPlot}}
#' @method addPlot reveal
#' @S3method addPlot reveal
addPlot.reveal = function(doc, fun, pointsize=getOption("ReporteRs-fontsize"), vector.graphic = T, width=6, height=6, fontname = getOption("ReporteRs-default-font"), ... ) {
